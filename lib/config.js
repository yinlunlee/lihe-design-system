...
module.exports = {
  ...
  staffAccounts: Object.assign(
    {"S01":"lihe2026","S02":"lihe2026","S03":"lihe2026","S04":"lihe2026","S05":"lihe2026","S06":"lihe2026","B01":"lihe2026"},
    process.env.STAFF_ACCOUNTS ? JSON.parse(process.env.STAFF_ACCOUNTS) : {}
  ),

  // 员工角色映射
  staffRoles: {
    'S01': { name: '庄涛',   role: '设计师',         label: '设计师' },
    'S02': { name: '林协莎', role: '设计师',         label: '设计师' },
    'S03': { name: '颜大然', role: '软装设计师',     label: '软装设计师' },
    'S04': { name: '王润鹏', role: '施工图设计师',   label: '施工图设计师' },
    'S05': { name: '谢佳润', role: '施工监理',       label: '施工监理' },
    'S06': { name: '谢建彬', role: '施工监理',       label: '施工监理' },
    'B01': { name: '管理员', role: '管理员',         label: '管理员' },
  },
